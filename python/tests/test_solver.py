...
def _make_params(**kwargs) -> mm.SolverParams:  # type: ignore
    """Create solver parameters with specified optimizations."""
    params = _disabled_params()
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_buffer_too_big(params_tuple: tuple[bool, ...]) -> None:
    """Single buffer exceeds capacity."""
    params = _make_params(
        canonical_only=params_tuple[0],
        section_inference=params_tuple[1],
        dynamic_ordering=params_tuple[2],
        check_dominance=params_tuple[3],
        unallocated_floor=params_tuple[4],
        static_preordering=params_tuple[5],
        dynamic_decomposition=params_tuple[6],
        monotonic_floor=params_tuple[7],
    )
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_trivial_conflict(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_complex_conflict(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_fixed_buffer_conflict(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_empty_problem(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_single_buffer(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_two_overlapping_buffers(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_five_buffers_tight_fit(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_fixed_buffer_feasible(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_two_partitions(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_alignment_constraints(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_simple_temporal_gap(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_tetris_spatial_gaps(params_tuple: tuple[bool, ...]) -> None:
...
@pytest.mark.parametrize("params_tuple", PARAM_COMBINATIONS)
def test_complex_stairs_pattern(params_tuple: tuple[bool, ...]) -> None:
